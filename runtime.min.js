 ...
 */
(function(){function a(d){return d&&typeof(d.then)==="function"}var c={};var b=function(){this.machine=null;this.handlers=null;this.promise=Vow.promise();this.promise.abort=this.abort.bind(this);this.exited=false;this.onThen=this.moveNext.bind(this);this.onError=this.setException.bind(this);this.CONT=c};b.prototype.run=function(e,d){this.machine=e;this.handlers=d;this.moveNext();return this.promise};b.prototype.ret=function(d){if(this.exited){throw"Internal error: this method already exited"}this.exited=true;this.promise.fulfill(d)};b.prototype.setException=function(d){if(this.handlers&&this.handlers(d)===c){this.moveNext();return}this.promise.reject(d)};b.prototype.abort=function(d){this.exited=true;this.promise.reject(d)};b.prototype.moveNext=function(){var d=c;while(!this.exited&&d===c){try{d=this.machine()}catch(e){this.setException(e);return}if(a(d)){d.then(this.onThen,this.onError);return}else{if(d!==c&&!this.exited){this.setException("Awaited value is not a promise: "+d);return}}}};this.compilerSupport={TaskBuilder:b}})();
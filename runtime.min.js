 ...
 */
(function(){function a(d){return d&&typeof(d.then)==="function"}var c={};var b=function(){var d=this;this.machine=null;this.handlers=null;this.promise=Vow.promise();this.promise.abort=function(){d.abort()};this.exited=false;this.val=undefined;this.onFulfill=function(e){d.val=e;d.moveNext()};this.onReject=function(e){d.setException(e)};this.CONT=c};b.prototype.run=function(e,d){this.machine=e;this.handlers=d;this.moveNext();return this.promise};b.prototype.ret=function(d){if(this.exited){throw"Internal error: this method already exited"}this.promise.fulfill(d);this.dispose()};b.prototype.setException=function(d){if(this.handlers&&this.handlers(d)===c){this.moveNext()}else{this.promise.reject(d);this.dispose()}};b.prototype.dispose=function(){this.exited=true;this.machine=null;this.handlers=null;this.val=undefined};b.prototype.abort=function(d){this.promise.reject(d);this.dispose()};b.prototype.moveNext=function(){var d=c;while(!this.exited&&d===c){try{d=this.machine()}catch(e){this.setException(e);break}if(a(d)){if(d._isFulfilled){this.val=d.valueOf();d=c}else{this.val=undefined;d.then(this.onFulfill,this.onReject);break}}else{if(d!==c&&!this.exited){this.setException("Awaited value is not a promise: "+d);break}}}};this.compilerSupport={TaskBuilder:b}})();